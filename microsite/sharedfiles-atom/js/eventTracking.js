...
if (pathname.toLowerCase() === 'index.html' || pathname.toLowerCase().startsWith('aw-')  || pathname.toLowerCase().startsWith('pr-') ||pathname.toLowerCase().startsWith('our-product') || pathname.toLowerCase().startsWith('product_')) {
...
function conditionChecksForTrackingEvent(mixpanelEventName) {
	...
	if (
		...
		!(pathname.toLowerCase() === 'index.html' || pathname.toLowerCase().startsWith('aw-') || pathname.toLowerCase().startsWith('pr-') || pathname.toLowerCase().startsWith('our-product') || pathname.toLowerCase().startsWith('product_'))
	) {
		return false;
	}
